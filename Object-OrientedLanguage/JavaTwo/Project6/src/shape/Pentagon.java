...
/**
 * A class that represents a Pentagon with a bounding box and color.
 * 
 * @author Norm Krumpe
 * 
 */
public class Pentagon extends Shape {
	...
	/**
	 * Creates a Pentagon that is a copy of this Pentagon, copying its
	 * color and all the details of its bounding box.
	 * 
	 * @param t
	 *            the Pentagon that is to be copied
	 */
