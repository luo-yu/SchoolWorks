...
/**
 * A class that represents an isosceles right triangle with a bounding
 * box and color.
 * 
 * @author Norm Krumpe
 * 
...
public class Triangle extends Shape {
	...
	/**
	 * Creates a triangle that is a copy of this triangle, copying its
	...
	public Point[] getVertices() {
		...
		result[2] = new Point(getX() + getWidth(), getY()
				+ getHeight());
	...
	public static void main(String[] args) {
		Triangle t = new Triangle(0, 0, 4, 4, Color.BLACK);
